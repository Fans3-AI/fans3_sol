...
export const server1 = new ServerConfiguration<{  }>("https://backend.mindfans.ai/voice-agent/test/api", {  })
export const server2 = new ServerConfiguration<{  }>("http://127.0.0.1:8000", {  })
export const server3 = new ServerConfiguration<{  }>("https://backend.mindfans.ai/test/api", {  })
export const server4 = new ServerConfiguration<{  }>("https://backend.mindfans.ai/api", {  })
